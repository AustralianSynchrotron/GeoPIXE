...
;-
    junk = self->get_data()
    for i=0L, self.n_detectors-1 do begin
...
;-
    if n_elements(calibration) eq 1 then begin
        ...
        cal = calibration
    endelse
    for i=0L, n_elements(cal)-1 do begin
...
;-
    if n_elements(elapsed) eq 1 then begin
        ...
        el = elapsed
    endelse
    for i=0L, n_elements(el)-1 do begin
...
;-
    ...
    if (keyword_set(align)) then begin
        ...
        oc1 = o1/s1
        for i=1L,self.n_detectors-1 do begin
