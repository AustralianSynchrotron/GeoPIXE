...
;       version numbers
;  Version 4.1
;		Mar 29, 2023  Chris Ryan
;			Fixed line character limit in MCA_READ_ASCII_FILE for large detector arrays
...
;       for i=0L, count-1 do print, env[i].name, '=', env[i].value
;
; MODIFICATION HISTORY:
...
COMPILE_OPT STRICTARR
    ...
    for i=0L, self.nrois-1 do begin
...
COMPILE_OPT STRICTARR
    ...
    while (~ EOF(unit)) do begin
        ...
        value = strtrim(strmid(line, pos), 2)
        case tag of
            'VERSION:'   :  t = 0; No-op
...
;
; EXAMPLE:
;       mca_read_netcdf_file, 'mca.001', Elapsed, Calibration, Rois, Roi_info, Data
;
; MODIFICATION HISTORY:
...
COMPILE_OPT STRICTARR
    ...
    for i=0L, status.ngatts-1 do begin
...
;*****************************************************************************
pro mca::free_environment

COMPILE_OPT STRICTARR
    if ptr_valid( self.environment) then ptr_free, self.environment
